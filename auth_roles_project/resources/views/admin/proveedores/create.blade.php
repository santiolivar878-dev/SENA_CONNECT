...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
    <h2 style="font-family:'Bebas Neue', sans-serif; font-size:32px; letter-spacing:3px;">Registrar Proveedor</h2>
...
<div style="background:#fff; border:1px solid #eee; padding:32px; max-width:600px;">
    <form action="{{ route('proveedores.store') }}" method="POST">
        ...
        <div class="sl-form-group">
            ...
            <input type="text" name="telefono" class="sl-input" value="{{ old('telefono') }}" required>
        </div>
        <div class="sl-form-group">
            <label class="sl-label">Correo</label>
            <input type="email" name="correo" class="sl-input" value="{{ old('correo') }}" required>
        </div>
        <div class="sl-form-group">
