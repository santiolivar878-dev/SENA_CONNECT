...
<div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:24px;">
    <h2 style="font-family:'Bebas Neue', sans-serif; font-size:32px; letter-spacing:3px;">Editar Usuario</h2>
...
<div style="background:#fff; border:1px solid #eee; padding:32px; max-width:600px;">
    <form action="{{ route('usuarios.update', $user) }}" method="POST">
        ...
        <div class="sl-form-group">
            ...
            <input type="text" name="name" class="sl-input" value="{{ old('name', $user->name) }}" required>
        </div>
        <div class="sl-form-group">
            <label class="sl-label">Email</label>
            <input type="email" name="email" class="sl-input" value="{{ old('email', $user->email) }}" required>
        </div>
        <div class="sl-form-group">
            <label class="sl-label">Contraseña <small style="opacity:0.5; font-size:10px;">(dejar en blanco para no cambiar)</small></label>
            <input type="password" name="password" class="sl-input">
        </div>
        <div class="sl-form-group">
            <label class="sl-label">Confirmar Contraseña</label>
            <input type="password" name="password_confirmation" class="sl-input">
        </div>
        <div class="sl-form-group">
